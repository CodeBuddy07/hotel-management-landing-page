  ...
  return (
    <div className="w-full container mx-auto px-5">
      <div className="  w-full max-w-5xl space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-4 border border-blue-100 px-4 py-6 rounded-xl">
          {/* Check-In */}
          <div className="flex flex-col gap-1">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-[200px] justify-start text-left rounded-full px-4 bg-gray-100"
                >
